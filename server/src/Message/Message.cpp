...
bool Dufos::Message::Message::sendMessage(Name name, Server& server, std::uint32_t id)
{
    try {
        bool success = false;
...
bool Dufos::Message::Message::recvMessage(Network::Data::Message& message, Server& server, std::uint32_t id)
{
    try {
